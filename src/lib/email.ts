...
export function welcomeEmail(agent: Agent, dashboardUrl: string) {
  ...
  const inner = `<div style="padding:30px;">
    ...
    <div style="margin-top:26px;font-size:13px;color:#9a948a;line-height:1.6;">Your private dashboard is below. <strong style="color:#ece6da;">This link is your login</strong> — bookmark it and keep it to yourself.</div>
    ${btn(dashboardUrl, 'Open your dashboard →')}
    <div style="margin-top:24px;font-size:13px;color:#9a948a;line-height:1.6;">Whenever we add a new car, you'll get an email with the details and a link to start quoting.</div>
  </div>`;
  const text = `Welcome to CK Retro Garage, ${agent.name}.\n\nHow it works:\n1. You get access to cars we have available to sell.\n2. Each car has a confidential minimum price — your floor. Your client never sees it.\n3. You choose the asking price you quote (at or above the minimum).\n4. You keep 70% of everything above the minimum. At the minimum you earn nothing.\n\nExample: minimum $100,000, sell at $120,000 → you earn $14,000.\n\nYour private dashboard (this link is your login — keep it private):\n${dashboardUrl}\n\n— CK Retro Garage`;
